...
from toolkits.set_SEED_naming import set_SEED_naming

# --------------------------------------------------------------------------------------
def export_waveform(tr: obspy.core.trace.Trace, output_folder: str, network = None):
    '''
    - Description: This function focuses on exporting a trace object as format MSEED from a trace, network
                   and output folder as input.
